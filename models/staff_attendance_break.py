...
try:
    ...
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS staff_attendance_break (
            break_time_id INTEGER PRIMARY KEY AUTOINCREMENT,
            break_start TIME NOT NULL,
            break_end TIME, -- Allow NULL for ongoing breaks
            employee_id INTEGER NOT NULL,
            attendance_id INTEGER NOT NULL,
            FOREIGN KEY (attendance_id) REFERENCES staff_attendance(attendance_id) ON DELETE CASCADE
