...
class StaffTimeCard(ctk.CTkFrame):
    def __init__(self, master, employee_name, **kwargs):
        ...
        self.time_out_label = ctk.CTkLabel(self.time_frame, 
                                          ...
                                          text_color="#4e2d18",
                                          anchor="w")
        self.time_out_label.grid(row=0, column=1, sticky="w")
    ...
    def show_password_popup(self, action):
        """Show password popup for clock in/out actions"""
    ...
    def set_enabled(self, enabled):
        """Enable or disable the IN/OUT buttons"""
        if enabled:
            # Enable buttons - current date
